...
<div>
  {bookings?.map((booking,index)=>{
    ...
    key={booking._id} className='grid grid-cols-1 md:grid-cols-4 gap-6 p-6 border border-[#c4c7d2] rounded-lg mt-5 first:mt-12'>
{/* {car image + info} */}
...
<div className='tex-sm text-gray-500 text-right'>
  <p>Total Price</p>
