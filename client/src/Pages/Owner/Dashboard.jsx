...
<div className='hidden md:flex items-center justify-center w-12 h-12 rounded-full bg-blue-600/10'> 
...
<div>
  ...
  <p className='text-sm text-gray-500'>{booking.createdAt.split("T")[0]}</p>
    ...
    <div className='gap-2 flex items-center font-medium'>
...
{/* monthly revenue  */}
<div className='p-4 md:p-6 mb-6 border border-[#c4c7d2] rounded-md w-ful md:max-w-xs'>
